...
"use strict";var auth=require("./lib/auth"),helpers=require("./lib/helpers"),SwaggerClient=require("./lib/client"),deprecationWrapper=function(e,t){return helpers.log('This is deprecated, use "new SwaggerClient" instead.'),new SwaggerClient(e,t)};Array.prototype.indexOf||(Array.prototype.indexOf=function(e,t){for(var r=t||0,i=this.length;r<i;r++)if(this[r]===e)return r;return-1}),String.prototype.trim||(String.prototype.trim=function(){return this.replace(/^\s+|\s+$/g,"")}),String.prototype.endsWith||(String.prototype.endsWith=function(e){return this.indexOf(e,this.length-e.length)!==-1}),module.exports=SwaggerClient,SwaggerClient.ApiKeyAuthorization=auth.ApiKeyAuthorization,SwaggerClient.PasswordAuthorization=auth.PasswordAuthorization,SwaggerClient.Oauth1Authorization=auth.Oauth1Authorization,SwaggerClient.CookieAuthorization=auth.CookieAuthorization,SwaggerClient.SwaggerApi=deprecationWrapper,SwaggerClient.SwaggerClient=deprecationWrapper,SwaggerClient.SchemaMarkup=require("./lib/schema-markup");
},{"./lib/auth":2,"./lib/client":3,"./lib/helpers":4,"./lib/schema-markup":7}],2:[function(require,module,exports){
"use strict";var helpers=require("./helpers"),btoa=require("btoa"),createHmac=require("create-hmac"),createHash=require("create-hash"),CookieJar=require("cookiejar").CookieJar,_={each:require("lodash-compat/collection/each"),includes:require("lodash-compat/collection/includes"),isObject:require("lodash-compat/lang/isObject"),isArray:require("lodash-compat/lang/isArray")},SwaggerAuthorizations=module.exports.SwaggerAuthorizations=function(e){this.authz=e||{}};SwaggerAuthorizations.prototype.add=function(e,t){if(_.isObject(e))for(var i in e)this.authz[i]=e[i];else"string"==typeof e&&(this.authz[e]=t);return t},SwaggerAuthorizations.prototype.remove=function(e){return delete this.authz[e]},SwaggerAuthorizations.prototype.apply=function(e,t){var i=!0,r=!t,o=[],a=e.clientAuthorizations||this.authz;return _.each(t,function(e,t){"string"==typeof t&&o.push(t),_.each(e,function(e,t){o.push(t)})}),_.each(a,function(t,a){if(r||_.includes(o,a)){var s=t.apply(e);i=i&&!!s}}),i};var ApiKeyAuthorization=module.exports.ApiKeyAuthorization=function(e,t,i){this.name=e,this.value=t,this.type=i};ApiKeyAuthorization.prototype.apply=function(e){if("query"===this.type){var t;if(e.url.indexOf("?")>0){t=e.url.substring(e.url.indexOf("?")+1);var i=t.split("&");if(i&&i.length>0)for(var r=0;r<i.length;r++){var o=i[r].split("=");if(o&&o.length>0&&o[0]===this.name)return!1}}return e.url.indexOf("?")>0?e.url=e.url+"&"+this.name+"="+this.value:e.url=e.url+"?"+this.name+"="+this.value,!0}if("header"===this.type)return"undefined"==typeof e.headers[this.name]&&(e.headers[this.name]=this.value),!0};var CookieAuthorization=module.exports.CookieAuthorization=function(e){this.cookie=e};CookieAuthorization.prototype.apply=function(e){return e.cookieJar=e.cookieJar||new CookieJar,e.cookieJar.setCookie(this.cookie),!0};var PasswordAuthorization=module.exports.PasswordAuthorization=function(e,t){3===arguments.length&&(helpers.log("PasswordAuthorization: the 'name' argument has been removed, pass only username and password"),e=arguments[1],t=arguments[2]),this.username=e,this.password=t};PasswordAuthorization.prototype.apply=function(e){return"undefined"==typeof e.headers.Authorization&&(e.headers.Authorization="Basic "+btoa(this.username+":"+this.password)),!0};var Oauth1Authorization=module.exports.Oauth1Authorization=function(e,t,i){this.username=e,this.password=t,this.method=i};Oauth1Authorization.prototype.apply=function(e){if(!e.hasOwnProperty("clientAuthorizations"))return!0;var t=OAuth({consumer:{key:this.username,secret:this.password},signature_method:this.method,hash_function:function(e,t){var i;switch(this.signature_method){case"HMAC-SHA1":i=createHmac("sha1",t);break;case"HMAC-SHA256":i=createHmac("sha256",t)}return i=i.update(e),i.digest("base64")}});if(e.headers&&e.headers["Content-Type"]&&"application/x-www-form-urlencoded"===e.headers["Content-Type"])if(e.body&&e.body.indexOf("oauth_signature")===-1){if(!this.signature){for(var i={oauth_callback:"about:blank"},r=e.body.split("&"),o=0;o<r.length;o++){var a=r[o].split("=");i[a[0].trim()]=a[1].trim()}var s={url:e.url,method:e.method,data:i},n=t.authorize(s),h="";for(var u in n)h=h+"&"+encodeURIComponent(u)+"="+encodeURIComponent(n[u]);this.signature=h}e.body=this.signature.substring(1)}else this.signature=!1;else if("undefined"==typeof e.headers.Authorization){if(!this.signature){var d;switch("undefined"==typeof e.body&&(e.body=""),this.method){case"HMAC-SHA1":d=createHash("sha1"),d.update(e.body),d=d.digest("hex");break;case"HMAC-SHA256":d=createHash("sha256"),d.update(e.body),d=d.digest("hex")}var i={oauth_body_hash:d},s={url:e.url,method:e.method,data:i},n=t.authorize(s);this.signature=t.toHeader(n).Authorization}e.headers.Authorization=this.signature}else this.signature=!1;return!0};


},{"./helpers":4,"btoa":14,"cookiejar":18,"create-hash":20,"create-hmac":23,"lodash-compat/collection/each":62,"lodash-compat/collection/includes":65,"lodash-compat/lang/isArray":150,"lodash-compat/lang/isObject":154}],3:[function(require,module,exports){
...
},{"./auth":2,"./helpers":4,"./http":5,"./resolver":6,"./spec-converter":8,"./types/model":9,"./types/operation":10,"./types/operationGroup":11,"lodash-compat/array/indexOf":59,"lodash-compat/collection/find":63,"lodash-compat/collection/forEach":64,"lodash-compat/function/bind":68,"lodash-compat/lang/cloneDeep":148,"lodash-compat/lang/isArray":150,"lodash-compat/lang/isFunction":152,"lodash-compat/lang/isObject":154,"lodash-compat/lang/isPlainObject":155,"lodash-compat/lang/isUndefined":158,"q":168}],4:[function(require,module,exports){
(function (process){
...
},{"_process":167,"lodash-compat/array/indexOf":59,"lodash-compat/lang/isPlainObject":155}],5:[function(require,module,exports){
(function (Buffer){
...
},{"./helpers":4,"buffer":15,"js-yaml":29,"lodash-compat/lang/isObject":154,"lodash-compat/object/keys":159,"superagent":191}],6:[function(require,module,exports){
...
},{"./http":5,"lodash-compat/lang/cloneDeep":148,"lodash-compat/lang/isArray":150,"lodash-compat/lang/isObject":154,"lodash-compat/lang/isString":156}],7:[function(require,module,exports){
...
},{"./helpers":4,"lodash-compat/array/indexOf":59,"lodash-compat/collection/forEach":64,"lodash-compat/collection/map":66,"lodash-compat/lang/cloneDeep":148,"lodash-compat/lang/isArray":150,"lodash-compat/lang/isEmpty":151,"lodash-compat/lang/isObject":154,"lodash-compat/lang/isPlainObject":155,"lodash-compat/lang/isUndefined":158,"lodash-compat/object/keys":159}],8:[function(require,module,exports){
...
},{"./http":5,"lodash-compat/lang/isObject":154}],9:[function(require,module,exports){
...
},{"../helpers":4,"../schema-markup.js":7,"js-yaml":29,"lodash-compat/lang/isPlainObject":155,"lodash-compat/lang/isString":156}],10:[function(require,module,exports){
...
},{"../helpers":4,"../http":5,"./model":9,"lodash-compat/lang/cloneDeep":148,"lodash-compat/lang/isEmpty":151,"lodash-compat/lang/isObject":154,"lodash-compat/lang/isUndefined":158,"q":168}],11:[function(require,module,exports){
...
},{"base64-js":12,"ieee754":25,"is-array":27}],16:[function(require,module,exports){
(function (Buffer){
...
},{"buffer":15,"inherits":26,"stream":178,"string_decoder":190}],17:[function(require,module,exports){
...
},{"../../is-buffer/index.js":28}],20:[function(require,module,exports){
(function (Buffer){
...
},{"./md5":22,"buffer":15,"cipher-base":16,"inherits":26,"ripemd160":169,"sha.js":171}],21:[function(require,module,exports){
(function (Buffer){
...
},{"buffer":15,"create-hash/browser":20,"inherits":26,"stream":178}],24:[function(require,module,exports){
...
},{"../internal/baseIndexOf":88,"../internal/binaryIndex":102}],60:[function(require,module,exports){
...
},{"../internal/LazyWrapper":70,"../internal/LodashWrapper":71,"../internal/baseLodash":92,"../internal/isObjectLike":136,"../internal/wrapperClone":147,"../lang/isArray":150}],62:[function(require,module,exports){
module.exports=require("./forEach");


},{"./forEach":64}],63:[function(require,module,exports){
...
},{"../internal/baseEach":81,"../internal/createFind":112}],64:[function(require,module,exports){
...
},{"../internal/arrayEach":73,"../internal/baseEach":81,"../internal/createForEach":113}],65:[function(require,module,exports){
...
},{"../internal/baseIndexOf":88,"../internal/getLength":122,"../internal/isIterateeCall":132,"../internal/isLength":135,"../lang/isArray":150,"../lang/isString":156,"../object/values":162}],66:[function(require,module,exports){
...
},{"../internal/arrayMap":74,"../internal/baseCallback":77,"../internal/baseMap":93,"../lang/isArray":150}],67:[function(require,module,exports){
...
},{"../internal/getNative":124}],68:[function(require,module,exports){
...
},{"../internal/createWrapper":116,"../internal/replaceHolders":142,"./restParam":69}],69:[function(require,module,exports){
...
},{"./baseCreate":80,"./baseLodash":92}],71:[function(require,module,exports){
...
},{"./baseCreate":80,"./baseLodash":92}],72:[function(require,module,exports){
...
},{"../object/keys":159,"./baseCopy":79}],77:[function(require,module,exports){
...
},{"../utility/identity":164,"../utility/property":166,"./baseMatches":94,"./baseMatchesProperty":95,"./bindCallback":104}],78:[function(require,module,exports){
...
},{"../lang/isArray":150,"../lang/isObject":154,"./arrayCopy":72,"./arrayEach":73,"./baseAssign":76,"./baseForOwn":86,"./initCloneArray":126,"./initCloneByTag":127,"./initCloneObject":128,"./isHostObject":130}],79:[function(require,module,exports){
...
},{"../lang/isObject":154}],81:[function(require,module,exports){
...
},{"./baseForOwn":86,"./createBaseEach":108}],82:[function(require,module,exports){
...
},{"./createBaseFor":109}],85:[function(require,module,exports){
...
},{"../object/keysIn":160,"./baseFor":84}],86:[function(require,module,exports){
...
},{"../object/keys":159,"./baseFor":84}],87:[function(require,module,exports){
...
},{"./toObject":145}],88:[function(require,module,exports){
...
},{"./indexOfNaN":125}],89:[function(require,module,exports){
...
},{"../lang/isObject":154,"./baseIsEqualDeep":90,"./isObjectLike":136}],90:[function(require,module,exports){
...
},{"../lang/isArray":150,"../lang/isTypedArray":157,"./equalArrays":117,"./equalByTag":118,"./equalObjects":119,"./isHostObject":130}],91:[function(require,module,exports){
...
},{"./baseIsEqual":89,"./toObject":145}],92:[function(require,module,exports){
...
},{"./baseEach":81,"./isArrayLike":129}],94:[function(require,module,exports){
...
},{"./baseIsMatch":91,"./getMatchData":123,"./toObject":145}],95:[function(require,module,exports){
...
},{"../array/last":60,"../lang/isArray":150,"./baseGet":87,"./baseIsEqual":89,"./baseSlice":99,"./isKey":133,"./isStrictComparable":137,"./toObject":145,"./toPath":146}],96:[function(require,module,exports){
...
},{"./toObject":145}],97:[function(require,module,exports){
...
},{"./baseGet":87,"./toPath":146}],98:[function(require,module,exports){
...
},{"../utility/identity":164,"./metaMap":139}],99:[function(require,module,exports){
...
},{"../utility/identity":164,"./binaryIndexBy":103}],103:[function(require,module,exports){
...
},{"../utility/identity":164}],105:[function(require,module,exports){
(function (global){
...
},{"./getLength":122,"./isLength":135,"./toObject":145}],109:[function(require,module,exports){
...
},{"./toObject":145}],110:[function(require,module,exports){
(function (global){
...
},{"./createCtorWrapper":111}],111:[function(require,module,exports){
...
},{"../lang/isObject":154,"./baseCreate":80}],112:[function(require,module,exports){
...
},{"../lang/isArray":150,"./baseCallback":77,"./baseFind":82,"./baseFindIndex":83}],113:[function(require,module,exports){
...
},{"../lang/isArray":150,"./bindCallback":104}],114:[function(require,module,exports){
(function (global){
...
},{"./arrayCopy":72,"./composeArgs":106,"./composeArgsRight":107,"./createCtorWrapper":111,"./isLaziable":134,"./reorder":141,"./replaceHolders":142,"./setData":143}],115:[function(require,module,exports){
(function (global){
...
},{"./createCtorWrapper":111}],116:[function(require,module,exports){
...
},{"./baseSetData":98,"./createBindWrapper":110,"./createHybridWrapper":114,"./createPartialWrapper":115,"./getData":120,"./mergeData":138,"./setData":143}],117:[function(require,module,exports){
...
},{"./arraySome":75}],118:[function(require,module,exports){
...
},{"../object/keys":159}],120:[function(require,module,exports){
...
},{"../utility/noop":165,"./metaMap":139}],121:[function(require,module,exports){
...
},{"./realNames":140}],122:[function(require,module,exports){
var baseProperty=require("./baseProperty"),getLength=baseProperty("length");module.exports=getLength;


},{"./baseProperty":96}],123:[function(require,module,exports){
...
},{"../object/pairs":161,"./isStrictComparable":137}],124:[function(require,module,exports){
...
},{"../lang/isNative":153}],125:[function(require,module,exports){
...
},{"./bufferClone":105}],128:[function(require,module,exports){
...
},{"./getLength":122,"./isLength":135}],130:[function(require,module,exports){
...
},{"../lang/isObject":154,"./isArrayLike":129,"./isIndex":131}],133:[function(require,module,exports){
...
},{"../lang/isArray":150,"./toObject":145}],134:[function(require,module,exports){
...
},{"../chain/lodash":61,"./LazyWrapper":70,"./getData":120,"./getFuncName":121}],135:[function(require,module,exports){
...
},{"../lang/isObject":154}],138:[function(require,module,exports){
...
},{"./arrayCopy":72,"./composeArgs":106,"./composeArgsRight":107,"./replaceHolders":142}],139:[function(require,module,exports){
(function (global){
var getNative=require("./getNative"),WeakMap=getNative(global,"WeakMap"),metaMap=WeakMap&&new WeakMap;module.exports=metaMap;


}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./getNative":124}],140:[function(require,module,exports){
...
},{"./arrayCopy":72,"./isIndex":131}],142:[function(require,module,exports){
...
},{"../date/now":67,"./baseSetData":98}],144:[function(require,module,exports){
...
},{"../lang/isArguments":149,"../lang/isArray":150,"../lang/isString":156,"../object/keysIn":160,"./isIndex":131,"./isLength":135}],145:[function(require,module,exports){
...
},{"../lang/isObject":154,"../lang/isString":156,"../support":163}],146:[function(require,module,exports){
...
},{"../lang/isArray":150,"./baseToString":100}],147:[function(require,module,exports){
...
},{"./LazyWrapper":70,"./LodashWrapper":71,"./arrayCopy":72}],148:[function(require,module,exports){
...
},{"../internal/baseClone":78,"../internal/bindCallback":104}],149:[function(require,module,exports){
...
},{"../internal/isArrayLike":129,"../internal/isObjectLike":136}],150:[function(require,module,exports){
...
},{"../internal/getNative":124,"../internal/isLength":135,"../internal/isObjectLike":136}],151:[function(require,module,exports){
...
},{"../internal/isArrayLike":129,"../internal/isObjectLike":136,"../object/keys":159,"./isArguments":149,"./isArray":150,"./isFunction":152,"./isString":156}],152:[function(require,module,exports){
...
},{"../internal/isHostObject":130,"../internal/isObjectLike":136,"./isFunction":152}],154:[function(require,module,exports){
...
},{"../internal/baseForIn":85,"../internal/isHostObject":130,"../internal/isObjectLike":136,"../support":163,"./isArguments":149}],156:[function(require,module,exports){
...
},{"../internal/isObjectLike":136}],157:[function(require,module,exports){
...
},{"../internal/isLength":135,"../internal/isObjectLike":136}],158:[function(require,module,exports){
...
},{"../internal/getNative":124,"../internal/isArrayLike":129,"../internal/shimKeys":144,"../lang/isObject":154,"../support":163}],160:[function(require,module,exports){
...
},{"../internal/arrayEach":73,"../internal/isIndex":131,"../internal/isLength":135,"../lang/isArguments":149,"../lang/isArray":150,"../lang/isFunction":152,"../lang/isObject":154,"../lang/isString":156,"../support":163}],161:[function(require,module,exports){
...
},{"../internal/toObject":145,"./keys":159}],162:[function(require,module,exports){
...
},{"../internal/baseValues":101,"./keys":159}],163:[function(require,module,exports){
...
},{"../internal/baseProperty":96,"../internal/basePropertyDeep":97,"../internal/isKey":133}],167:[function(require,module,exports){
...
},{"_process":167}],169:[function(require,module,exports){
(function (Buffer){
...
},{"buffer":15}],170:[function(require,module,exports){
(function (Buffer){
...
},{"./hash":170,"buffer":15,"inherits":26}],173:[function(require,module,exports){
(function (Buffer){
...
},{"./hash":170,"buffer":15,"inherits":26}],174:[function(require,module,exports){
(function (Buffer){
...
},{"./hash":170,"./sha256":175,"buffer":15,"inherits":26}],175:[function(require,module,exports){
(function (Buffer){
...
},{"./hash":170,"buffer":15,"inherits":26}],176:[function(require,module,exports){
(function (Buffer){
...
},{"./hash":170,"./sha512":177,"buffer":15,"inherits":26}],177:[function(require,module,exports){
(function (Buffer){
...
},{"./hash":170,"buffer":15,"inherits":26}],178:[function(require,module,exports){
...
},{"events":24,"inherits":26,"readable-stream/duplex.js":180,"readable-stream/passthrough.js":186,"readable-stream/readable.js":187,"readable-stream/transform.js":188,"readable-stream/writable.js":189}],179:[function(require,module,exports){
...
},{"./_stream_readable":183,"./_stream_writable":185,"_process":167,"core-util-is":19,"inherits":26}],182:[function(require,module,exports){
...
},{"./_stream_transform":184,"core-util-is":19,"inherits":26}],183:[function(require,module,exports){
(function (process){
...
},{"./_stream_duplex":181,"_process":167,"buffer":15,"core-util-is":19,"events":24,"inherits":26,"isarray":179,"stream":178,"string_decoder/":190,"util":13}],184:[function(require,module,exports){
...
},{"./_stream_duplex":181,"core-util-is":19,"inherits":26}],185:[function(require,module,exports){
(function (process){
...
},{"./_stream_duplex":181,"_process":167,"buffer":15,"core-util-is":19,"inherits":26,"stream":178}],186:[function(require,module,exports){
...
},{"./lib/_stream_duplex.js":181,"./lib/_stream_passthrough.js":182,"./lib/_stream_readable.js":183,"./lib/_stream_transform.js":184,"./lib/_stream_writable.js":185,"_process":167,"stream":178}],188:[function(require,module,exports){
...
},{"buffer":15}],191:[function(require,module,exports){
...
},{"./is-object":192,"./request":194,"./request-base":193,"emitter":17}],192:[function(require,module,exports){
